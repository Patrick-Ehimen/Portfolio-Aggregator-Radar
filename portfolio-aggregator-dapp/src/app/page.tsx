    ...
    <div className="flex flex-col min-h-screen">
      <header className="z-[50] sticky top-0 w-full bg-background/95 border-b backdrop-blur-sm dark:bg-black/[0.6] border-border/40">
        <div className="container h-14 flex items-center">
          ...
          >
            <Radar color="#88dd9d" className="w-6 hidden dark:block h-6 mr-3" />
            <Radar color="#0CAF60" className="w-6 dark:hidden h-6 mr-3" />

            <span className="font-bold">¶ortfolio Radar</span>
            <span className="sr-only">Portfolio Radar</span>

            <span className="text-[#88dd9d] hidden dark:block">•</span>
            <span className="text-[#0CAF60] dark:hidden">•</span>
          </Link>
          ...
          <section className="mx-auto flex max-w-[980px] flex-col items-center gap-2 py-8 md:py-12 md:pb-8 lg:py-24 lg:pb-6">
            ...
            <div className="flex w-full items-center justify-center space-x-4 py-4 md:pb-6">
              <Button
                variant="default"
                asChild
                className="bg-[#0CAF60] hover:bg-[#88dd9d] hover:text-black dark:bg-slate-100 dark:hover:bg-slate-300 "
              >
                <Link href="/dashboard">
                  Open App
